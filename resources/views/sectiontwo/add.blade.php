...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Penilaian Tahap II</li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="{{url($prefix.'/assessment/sectiontwo')}}" method="post" id="table">
                {{csrf_field()}}
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="visi_misi" value="" class="form-control" min="1" max="100" required="">
                </div>
                <div class="form-group">
                  <label>Catwalk</label>
