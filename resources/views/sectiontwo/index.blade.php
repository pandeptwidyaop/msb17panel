    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <a href="{{url($prefix.'/assessment/sectiontwo/create')}}" type="button" class="btn btn-flat btn-primary"><i class="fa fa-plus"></i> Tambah</a>
            <hr>
            <table class="table table-bordered table-striped" width="100%" id="table">
              <thead>
                ...
                <tr>
                  ...
                  <td width="8.2%"><center>Visi Misi (50%)</center></td>
              ...
              <tbody>
                @foreach ($data as $row)
                  <tr>
                    ...
                    <td><center>{{$row->visi_misi}}</center></td>
