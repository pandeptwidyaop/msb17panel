      ...
      <div class="col-md-12">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Penilaian Wawancara</h3>
          </div>
          <div class="box-body">
            <a href="{{url($prefix.'/assessment/interview/add')}}" type="button" class="btn btn-flat btn-primary"><i class="fa fa-plus"></i> Tambah</a>
            <hr>
            <table class="table table-bordered table-striped" width="100%" id="table">
              <thead>
                <tr>
                  ...
                  <th colspan="4" class="text-center"><center>Aspek Penilaian</center></th>
                  <th rowspan="2" class="text-center" width="5%"><center>Total</th>
                </tr>
                <tr>
                  <td width="18%"><center>Kemampuan Logika & Berpikir</center></td>
                  <td width="18%"><center>Kemampuan Menjawab Pertanyaan</center></td>
                  <td width="18%"><center>Komunikatif</center></td>
                  <td width="18%"><center>Percaya Diri</center></td>
                </tr>
              </thead>
              <tbody>
                @foreach ($data as $row)
                  <tr>
                    ...
                    <td><center>{{$row->komunikatif}}</center></td>
                    <td><center>{{$row->percaya_diri}}</center></td>
                    @php
                      $count = $row->kemampuan_logika_berpikir + $row->kemampuan_menjawab_pertanyaan + $row->komunikatif + $row->percaya_diri;
                    @endphp
