  ...
  <section class="content">
    <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="{{url($prefix.'/assessment/talent')}}" method="post" id="table">
                {{csrf_field()}}
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="minat_bakat" value="" class="form-control" min="1" max="100" required="">
                </div>
                <a href="{{url($prefix.'/assessment/talent')}}" class="btn btn-default btn-flat">Kembali</a>
