    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <a href="{{url($prefix.'/assessment/sectionthree/create')}}" type="button" class="btn btn-flat btn-primary"><i class="fa fa-plus"></i> Tambah</a>
            <hr>
            <table class="table table-bordered table-striped" width="100%" id="table">
              <thead>
                <tr>
                  ...
                  <th colspan="9" rowspan="0" class="text-center"><center>Aspek Penilaian</center></th>
                  <th rowspan="3" class="text-center" width="5%"><center>Total</th>
                </tr>
                <tr>
                  <td width="" colspan="2"><center>Brain (30%)</center></td>
                  <td width="" colspan="4"><center>Beauty (35%)</center></td>
                  <td width="" colspan="3"><center>Behaviour (35%)</center></td>
                </tr>
                <tr>
                  <td width="8.2%"><center>Kemampuan Berpikir Logis (50%)</center></td>
                  <td width="8.2%"><center>Ketepatan Jawaban (50%)</center></td>
                  <td width="8.2%"><center>Catwalk (25%)</center></td>
                  <td width="8.2%"><center>Body Languange (25%)</center></td>
                  <td width="8.2%"><center>Ekspresi (25%)</center></td>
                  <td width="8.2%"><center>Kencantikan (25%)</center></td>
                  <td width="8.2%"><center>Public Speaking (40%)</center></td>
                  <td width="8.2%"><center>Sikap (30%)</center></td>
                  <td width="8.2%"><center>Percaya Diri (30%)</center></td>
                </tr>
              </thead>
              <tbody>
                @foreach ($data as $row)
                  <tr>
                    ...
                    <td>{{$row->name}}</td>
                    <td><center>{{$row->kemampuan_logika_berpikir}}</center></td>
                    <td><center>{{$row->ketepatan_jawaban}}</center></td>
